...
package com.ph4nf4n.core.MQTT
{
	...
	public class MQTTUtil
	{
		...
		protected function shortenString(str:String, len:int):String
		{
		 ...
		 *  @productversion Flex 3
		 */
		public static function createUID(len:int=0):String
		{
			...
			if(len) {
				var str:String = String.fromCharCode.apply(null, uid);
